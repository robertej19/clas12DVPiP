...
class fs:
	def __init__(self):
		...
		# self.xBbins = [0.15,0.20,0.25]#,0.30]#,0.38,0.48,0.58,0.80]
		# self.Q2bins =  [1.5,2,2.5,3]#,3.5,4,4.5]#,5.5,7,11]
		# self.tbins =  [0.09,0.15,0.2]#,0.3]#,0.4]#,0.6,1,1.5,2]
		# #self.phibins =  [0,36,72,108,144,180,216,252,288,324,360]
		# self.phibins =  [0,360]


		#self.xBbins = [0.1,0.15,0.20,0.25,.30]#,0.38,.43,0.48,0.58,0.80]
		#self.Q2bins =  [1,1.5,2,2.5,3]#,3.5,4,4.5,5,5.5,7,11]
